...
public:
    ...
    void compute_phi_ladder_operator_phi(vector<double> & dmat0);
...
public:
    ...
    void find_resonant_state_to_initial_state( double energy_window_cutoff , vector<vector<int> > & resonant_state_mode_list , vector<double> & resonant_state_energy , int resonant_state_number);
};
